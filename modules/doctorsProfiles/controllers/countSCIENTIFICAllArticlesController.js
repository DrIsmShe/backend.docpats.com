...
const countSCIENTIFICAllArticlesController = async (req, res) => {
  try {
    const totalArticles = await ArticleScince.countDocuments(); // Подсчет всех статей в базе
...
export default countSCIENTIFICAllArticlesController;
