...
// не должно быть.
//
// Что именно выключается: перевод вопроса при публикации
// (education-items → reviewItem) и перевод названия теста при публикации и
// при открытии каталога (education-catalog → program.service).
//
// Что НЕ выключается: ручной перевод из админки (education-translation:
// «Перевести» у вопроса) и перевод названий РУБРИК — рубрика одна на все
// языки, и её имя обязано читаться каждым.
//
