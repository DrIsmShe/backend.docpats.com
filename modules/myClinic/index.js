...
import privatePatientDeleteFromDoctorRoute from "./routes/privatePatientDeleteFromDoctorRoute.js";

import restorePrivatePatientFromArchiveRoute from "./routes/restorePrivatePatientFromArchiveRoute.js";

import restoreRegistredPatientFromArchiveRoute from "./routes/restoreRegistredPatientFromArchiveRoute.js";
...
router.use(
  "/private-patient-delete-from-offices-doctor",
  privatePatientDeleteFromDoctorRoute,
);
router.use(
  "/registred-patient-restore-from-archive",
  restoreRegistredPatientFromArchiveRoute,
);
router.use(
  "/private-patient-restore-from-archive",
  restorePrivatePatientFromArchiveRoute,
);
