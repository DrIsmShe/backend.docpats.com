...
const tempAdditionalDiagnosisDetailGetController = async (req, res) => {
  try {
    ...
    const complaint = await TempAdditionalDiagnosis.findById(_id);
...
export default tempAdditionalDiagnosisDetailGetController;
