  ...
  try {
    ...
    if (!allowedSpecializations.includes(specializationName)) {
      return res.status(403).json({
        message:
          "Access is permitted only to specialists in Functional Neurosurgeon, Cardiac Surgeon,  Vascular Surgeon, Diagnostics Specialist, Pediatric Cardiologist, Interventional Cardiologist, Cardiologist, Radiologist, ",
      });
    }
