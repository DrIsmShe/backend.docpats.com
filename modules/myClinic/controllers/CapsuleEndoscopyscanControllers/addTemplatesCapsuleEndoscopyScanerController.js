...
const addTemplateCapsuleEndoscopyScannerControllerNameofexam = (req, res) =>
  handleTemplateCreation(
    req,
    res,
    CapsuleEndoscopyScannerTemplateNameofexam,
    "nameofexam"
  );

const addTemplateCapsuleEndoscopyScannerControllerReport = (req, res) =>
  handleTemplateCreation(
    req,
    res,
    CapsuleEndoscopyScannerTemplateReport,
    "report"
  );

const addTemplateCapsuleEndoscopyScannerControllerDiagnosis = (req, res) =>
  handleTemplateCreation(
    req,
    res,
    CapsuleEndoscopyScannerTemplateDiagnosis,
    "diagnosis"
  );

const addTemplateCapsuleEndoscopyScannerControlleRecomandation = (req, res) =>
  handleTemplateCreation(
    req,
    res,
    CapsuleEndoscopyScannerTemplateRecomandation,
    "recommendations"
  );

export default {
  addTemplateCapsuleEndoscopyScannerControllerNameofexam,
  addTemplateCapsuleEndoscopyScannerControllerReport,
  addTemplateCapsuleEndoscopyScannerControllerDiagnosis,
  addTemplateCapsuleEndoscopyScannerControlleRecomandation,
};
