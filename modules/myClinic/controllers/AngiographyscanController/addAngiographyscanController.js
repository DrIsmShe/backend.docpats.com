  ...
  try {
    ...
    if (!allowedSpecializations.includes(specializationName)) {
      return res.status(403).json({
        message:
          "Access is permitted only to specialists in cardiology and functional diagnostics, cardiologists, invasive cardiologists,  pediatric cardiologists, Cardiac Surgeon, Vascular Surgeon .",
      });
    }
