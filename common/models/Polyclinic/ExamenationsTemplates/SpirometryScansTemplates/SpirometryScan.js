...
const spirometrySchema = new mongoose.Schema(
  {
    ...
    nameofexamTemplate: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "SpirometryScanTemplateNameofexam",
    },
    reportTemplate: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "SpirometryScanTemplateReport",
    },
    diagnosisTemplate: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "SpirometryScanTemplateDiagnosis",
    },
    recomandationTemplate: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "SpirometryScanTemplateRecomandation",
    },
...
const SpirometryScan = mongoose.model("SpirometryScan", spirometrySchema);

export default SpirometryScan;
