...
const coronographySchema = new mongoose.Schema(
  {
    patientId: {
      type: mongoose.Schema.Types.ObjectId,
    ...
    nameofexamTemplate: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "CoronographyScanTemplateNameofexam",
    },
    reportTemplate: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "CoronographyscanTemplateReport",
    },
    diagnosisTemplate: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "CoronographyscanTemplateDiagnosis",
    },
    recomandationTemplate: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "CoronographyscanTemplateRecomandation",
    },
...
const CoronographyScan = mongoose.model("CoronographyScan", coronographySchema);

export default CoronographyScan;
