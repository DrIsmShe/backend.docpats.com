...
const echoekgSchema = new mongoose.Schema(
  {
    patientId: {
      type: mongoose.Schema.Types.ObjectId,
    ...
    nameofexamTemplate: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "EchoEKGScanTemplateNameofexam",
    },
    reportTemplate: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "EchoEKGscanTemplateReport",
    },
    diagnosisTemplate: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "EchoEKGscanTemplateDiagnosis",
    },
    recomandationTemplate: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "EchoEKGscanTemplateRecomandation",
    },
...
// Создаем модель EKG
const EchoEKGScan = mongoose.model("EchoEKGScan", echoekgSchema);

export default EchoEKGScan;
