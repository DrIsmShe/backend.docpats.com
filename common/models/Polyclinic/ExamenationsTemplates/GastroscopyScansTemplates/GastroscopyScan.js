...
const gastroscopySchema = new mongoose.Schema(
  {
    patientId: {
      type: mongoose.Schema.Types.ObjectId,
    ...
    nameofexamTemplate: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "GastroscopyScanTemplateNameofexam",
    },
    reportTemplate: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "GastroscopyScannTemplateReport",
    },
    diagnosisTemplate: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "GastroscopyScanTemplateDiagnosis",
    },
    recomandationTemplate: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "GastroscopyScanTemplateRecomandation",
    },
...
const GastroscopyScan = mongoose.model("GastroscopyScan", gastroscopySchema);

export default GastroscopyScan;
