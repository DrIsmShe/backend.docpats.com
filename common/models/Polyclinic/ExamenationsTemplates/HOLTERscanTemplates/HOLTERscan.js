...
const holterSchema = new mongoose.Schema(
  {
    patientId: {
      type: mongoose.Schema.Types.ObjectId,
    ...
    nameofexamTemplate: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "HOLTERScanTemplateNameofexam",
    },
    reportTemplate: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "HOLTERscanTemplateReport",
    },
    diagnosisTemplate: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "HOLTERscanTemplateDiagnosis",
    },
    recomandationTemplate: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "HOLTERscanTemplateRecomandation",
    },
    ...
    dopplerFindings: { type: String }, // Анализ кровотока
    monitoringDuration: { type: Number },
    maxHeartRate: { type: Number },
    minHeartRate: { type: Number },
    arrhythmiaEpisodes: [{ type: String }],
    echogenicity: { type: String }, // Гиперэхогенность, гипоэхогенность и т. д.
    probeFrequency: { type: Number }, // Частота датчика (МГц)
    // Связанные исследования
    previousStudy: { type: mongoose.Schema.Types.ObjectId, ref: "HOLTERScan" }, // Предыдущие КТ пациента
    relatedStudies: [
...
const HOLTERScan =
  mongoose.models.HOLTERScan || mongoose.model("HOLTERScan", holterSchema);

export default HOLTERScan;
