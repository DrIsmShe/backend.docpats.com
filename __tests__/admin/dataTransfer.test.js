...
// Рабочая база приложения отдаётся вместе со списком: без неё на машине
// разработчика невозможно понять, что переносишь боевые данные, работая при
// этом на черновой базе. Именно это расхождение и порождает путаницу.
describe("рабочая база приложения", () => {
